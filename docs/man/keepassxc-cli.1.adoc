...
*attachment-export* <__database__> <__entry__> <__name__>::
  Exports the content of an attachment of an entry to standard output.

*attachment-import* [_options_] <__database__> <__entry__> <__name__> <__attachment__>::
...
*attachment-rm* <__database__> <__entry__> <__name__>::
  Removes the attachment of an entry.
